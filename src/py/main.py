"""
CLI entry point for the Dittmann-Maug replication pipeline.

Parses arguments, runs the pipeline, and writes all output artifacts to disk.
...
def main() -> int:
    """Run the pipeline and write all outputs; return exit code 0 on success."""
    args = parse_args()
    config = RunConfig(
