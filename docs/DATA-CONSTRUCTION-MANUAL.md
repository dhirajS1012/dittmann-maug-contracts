...
**Related Files:**
- `docs/dittman-maug-contract-construction-procedure.md` - Technical specification
...
- `src/py/dittmann_maug/contracts/stage1_inputs.py` - Our Python implementation
...
By building this formula with contract parameters ($\phi$, $n_s$, $n_o$, $K$), researchers can ask questions like:
- "How does CEO wealth change if stock price increases 1%?"
- "Is the CEO paid more for taking on risk?"
- "Do options create perverse incentives?"
